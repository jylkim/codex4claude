...
QUERY="${1:?Usage: oracle.sh \"<query>\"}"

SYSTEM_PROMPT='You are a strategic technical advisor with deep reasoning capabilities, operating as a specialized consultant within an AI-assisted development environment.
...
---
Query:
${QUERY}" -m gpt-5.1-codex-max -s read-only 2>/dev/null
